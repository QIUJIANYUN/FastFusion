...
FastFusionTracker::FastFusionTracker(Vector2i imgSize, TrackerIterationType *trackingRegime, int noHierarchyLevels,
...
void FastFusionTracker::SetupLevels(int numIterCoarse, int numIterFine, float distThreshCoarse, float distThreshFine)
{
...
void FastFusionTracker::SetEvaluationData(ITMTrackingState *trackingState, const ITMView *view)
{
...
void FastFusionTracker::PrepareForEvaluation()
{
...
void FastFusionTracker::SetEvaluationParams(int levelId)
{
...
void FastFusionTracker::ComputeDelta(float *step, float *nabla, float *hessian, bool shortIteration) const
{
...
bool FastFusionTracker::HasConverged(float *step) const
{
...
void FastFusionTracker::ApplyDelta(const Matrix4f & para_old, const float *delta, Matrix4f & para_new) const
{
    float step[6];
...
void FastFusionTracker::UpdatePoseQuality(int noValidPoints_old, float *hessian_good, float f_old)
{
